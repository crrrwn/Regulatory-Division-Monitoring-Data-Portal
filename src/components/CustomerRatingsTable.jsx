        ...
        <table className="w-full text-sm border-collapse">
          <thead>
            <tr className="bg-[#f0f5ee] border-b-2 border-[#1e4d2b]/15">
              <th className="text-center py-2 px-3 font-semibold text-[#1e4d2b] uppercase text-[9px]">Rating Criteria</th>
              <th className="text-center py-2 px-3 w-48 font-semibold text-[#1e4d2b] uppercase text-[9px]">Score</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-[#e8e0d4]">
            <tr className="hover:bg-[#faf8f5]/80 transition-colors duration-200">
              <td className="py-4 px-4 font-medium text-[#1e4d2b] text-left">1. Quantity of Services Provided</td>
            ...
            <tr className="hover:bg-[#faf8f5]/80 transition-colors duration-200">
              <td className="py-4 px-4 font-medium text-[#1e4d2b] text-left">2. Personnel Service Quality</td>
              <td className="py-4 px-4">
                <div className="flex justify-center">
            ...
            <tr className="hover:bg-[#faf8f5]/80 transition-colors duration-200">
              <td className="py-4 px-4 pl-8 text-[#5c574f] italic">2.1 Relevance of training</td>
              <td className="py-4 px-4">
                <div className="flex justify-center">
            ...
            <tr className="hover:bg-[#faf8f5]/80 transition-colors duration-200">
              <td className="py-4 px-4 pl-8 text-[#5c574f] italic">2.2 Attitude (Courteousness)</td>
              <td className="py-4 px-4">
                <div className="flex justify-center">
            ...
            <tr className="hover:bg-[#faf8f5]/80 transition-colors duration-200">
              <td className="py-4 px-4 pl-8 text-[#5c574f] italic">2.3 Promptness</td>
              <td className="py-4 px-4">
                <div className="flex justify-center">
