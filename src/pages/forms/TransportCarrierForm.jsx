...
export default function TransportCarrierForm() {
  ...
  const [dateOfInspectionAndMonitoring, setDateOfInspectionAndMonitoring] = useState('')
  ...
  const handleAttachmentChange = (e) => {
    ...
    handleFileAttachment(file, {
      collectionName: 'transportCarrier',
      setUploading,
      setMessage,
  ...
  const handleSubmit = async (e) => {
    ...
    setDateOfInspectionAndMonitoring('')
    ...
    <FormLayout title="Transport Carrier Accreditation">
      <div className="w-full max-w-5xl mx-auto pb-10 px-3 xs:px-4 sm:px-5 min-w-0">
            ...
            <div className="relative z-10 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-[11px] font-semibold text-white/85 tracking-wider mt-0.5">
                  Registration form for livestock, poultry, and by-products transport vehicles. Fields connected to View Records.
                </p>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="transport-carrier-section bg-white p-6 sm:p-7 rounded-2xl border-2 border-[#e8e0d4] shadow-lg shadow-[#1e4d2b]/8 hover:shadow-xl hover:shadow-[#1e4d2b]/12 hover:-translate-y-0.5 transition-all duration-500 ease-[cubic-bezier(0.33,1,0.68,1)]">
            ...
            <div className="grid sm:grid-cols-2 gap-5">
              ...
              <div>
                <label className={labelClass}>Date of Inspection and Monitoring</label>
                <input type="date" value={dateOfInspectionAndMonitoring} onChange={(e) => setDateOfInspectionAndMonitoring(e.target.value)} className={inputClass} />
              </div>
              <div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  {attachmentFileName && (
                    <button type="button" onClick={() => { setAttachmentFileName(''); setAttachmentData('') }} className="p-2.5 text-red-600 bg-red-50 hover:bg-red-100 rounded-xl hover:scale-110 active:scale-95 transition-all duration-300" title="Remove File">
                      <iconify-icon icon="mdi:trash-can-outline" width="20"></iconify-icon>
                    </button>
                  )}
                </div>
                <p className="mt-2 text-[10px] text-[#5c574f]">
                  {attachmentFileName ? <span className="text-[#1e4d2b] font-bold">Selected: {attachmentFileName}</span> : 'Max file size: 25 MB (Images/PDF)'}
                </p>
              </div>
              <div>
